...
local Section = Tab:NewSection("Added Brand New Animations! 10/9/2022")
...
Section:NewButton("Click To Copy!", "updates for this shitty script", function()
	setclipboard("https://discord.gg/FhWAqrhksf")
	toclipboard("https://discord.gg/FhWAqrhksf")
end)
